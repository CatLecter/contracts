...
type UserClient interface {
	Register(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*LoginResponse, error)
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error)
	Get(ctx context.Context, in *UserBriefRequest, opts ...grpc.CallOption) (*UserResponse, error)
	Create(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserBriefResponse, error)
	Update(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error)
	Delete(ctx context.Context, in *UserBriefRequest, opts ...grpc.CallOption) (*UserBriefResponse, error)
}
...
func (c *userClient) Register(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
...
func (c *userClient) Create(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserBriefResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userClient) Delete(ctx context.Context, in *UserBriefRequest, opts ...grpc.CallOption) (*UserBriefResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserBriefResponse)
...
type UserServer interface {
	Register(context.Context, *UserRequest) (*LoginResponse, error)
	Login(context.Context, *LoginRequest) (*LoginResponse, error)
	Get(context.Context, *UserBriefRequest) (*UserResponse, error)
	Create(context.Context, *UserRequest) (*UserBriefResponse, error)
	Update(context.Context, *UserRequest) (*UserResponse, error)
	Delete(context.Context, *UserBriefRequest) (*UserBriefResponse, error)
...
func (UnimplementedUserServer) Register(context.Context, *UserRequest) (*LoginResponse, error) {
...
func (UnimplementedUserServer) Create(context.Context, *UserRequest) (*UserBriefResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedUserServer) Update(context.Context, *UserRequest) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedUserServer) Delete(context.Context, *UserBriefRequest) (*UserBriefResponse, error) {
...
func _User_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Delete(ctx, req.(*UserBriefRequest))
	}
	return interceptor(ctx, in, info, handler)
}
